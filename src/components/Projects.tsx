...
const Projects = () => {
  return (
    <section
      className="custom-container mb-12 px-4 sm:px-8 lg:px-12"
      id="projects"
    >
      ...
      <ProjectPanel>
        <motion.div
          ...
          className="group relative col-span-3 col-start-3 row-span-2 flex rounded-4xl"
        >
          <div className="absolute inset-0 bg-project-one-three bg-size-[auto_100%] transition-all duration-300 clip-path-[inset(0_0_calc(50%+0.5rem)_0_round_2rem_2rem_2rem_0)] group-hover:bg-size-[auto_105%] group-active:bg-size-[auto_105%]"></div>
          <div className="absolute inset-0 bg-project-one-three bg-size-[auto_100%] transition-all duration-300 clip-path-[inset(calc(50%-1.5rem)_calc(33.33%+0.33rem)_0_0_round_0_0_2rem_2rem)] group-hover:bg-size-[auto_105%] group-active:bg-size-[auto_105%]"></div>
          <div className="absolute inset-0 bg-project-one-three bg-size-[auto_100%] transition-all duration-300 clip-path-[inset(calc(50%-0.6rem)_20%_25%_calc(100%-(33.33%+0.33rem)-0.1rem))] group-hover:bg-size-[auto_105%] group-active:bg-size-[auto_105%]"></div>
        ...
        <motion.a
          {...animateOnScroll(fadeUp)}
          className="group absolute inset-0 z-1 col-span-1 col-start-5 row-span-1 row-start-2 flex items-center justify-center overflow-hidden rounded-4xl bg-project-one-two bg-size-[auto_120%] bg-center transition-all duration-300 hover:bg-size-[auto_130%] active:bg-size-[auto_130%]"
        ...
        >
          ...
          <ButtonPrompt
            iconName="Github"
            className="opacity-0 transition-all duration-300 group-hover:opacity-100 group-active:opacity-100"
          />
        </motion.a>
        ...
        <motion.div
          {...animateOnScroll(fadeUp)}
          className="col-start-4 row-start-3 rounded-4xl bg-project-one-four bg-size-[auto_120%] bg-left transition-all duration-300 hover:bg-size-[auto_130%] active:bg-size-[auto_130%]"
        ></motion.div>
      ...
      <ProjectPanel>
        ...
        <div className="col-span-2 col-start-4 row-span-4 row-start-2 lg:col-start-5">
          <ProjectDetails
            title="PulseVR"
          ...
          >
            ...
            that offers virtual reality experiences. It features a modern design
            and a responsive layout. Built with React.js and Tailwind,
