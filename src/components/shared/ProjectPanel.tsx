...
const ProjectPanel = () => {
  return (
    <div className="grid grid-cols-5 gap-4 lg:project-entry relative">
      <div className="aspect-square"></div>
      <div className="aspect-square row-start-2"></div>
      <div className="aspect-square row-start-3"></div>

      <div className="grid grid-cols-5 gap-4 lg:project-entry absolute inset-0">
        <motion.div
        ...
        <motion.div
          {...animateOnScroll(fadeUp)}
          className="rounded-4xl bg-gray-100 col-start-6 lg:block hidden"
        ></motion.div>
        <motion.div
          {...animateOnScroll(fadeUp)}
