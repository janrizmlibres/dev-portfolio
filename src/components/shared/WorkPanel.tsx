  ...
  return (
    ...
    >
      ...
      <div className="custom-container px-12 py-4 flex items-center gap-4">
        ...
        <p className="flex-2 text-xl group-hover:text-gray-200 transition-colors duration-400 ease-out">
          {company}
        </p>
        <div className="font-fira-code text-light-100 text-xl flex-3 group-hover:text-gray-200 transition-colors duration-400 ease-out">
