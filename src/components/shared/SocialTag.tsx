...
const SocialTag = ({ social: { name, url } }: { social: Social }) => {
  return (
    ...
    >
      <span className="absolute -z-1 inset-0 bg-light-100 scale-y-0 origin-bottom transition-transform duration-300 ease-out group-hover:scale-y-100 group-active:scale-y-100"></span>
