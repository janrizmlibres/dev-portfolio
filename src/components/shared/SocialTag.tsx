...
const SocialTag = ({ social: { name, url }, className }: Props) => {
  return (
    <a
      href={url}
      className={`group relative flex items-center justify-center gap-2 overflow-hidden rounded-full border-1 border-gray-200 px-7 py-3 text-sm italic ${className}`}
    >
